function [data_out, info_out] = adaptedResample_tts(data_in, info_in, omega_resample, tol, framerate)
...
if isfield(info_in,'paradigmFull')
    if isfield(info_in.paradigmFull, 'init_synchpts')
        info_out.paradigmFull.synchpts = round(N .* info_out.paradigmFull.init_synchpts ./ D);
        info_out.paradigmFull.synchpts(info_out.paradigmFull.synchpts == 0) = 1;
    elseif isfield(info_in.paradigmFull, 'synchpts')
        info_out.paradigmFull.init_synchpts=info_out.paradigmFull.synchpts;
