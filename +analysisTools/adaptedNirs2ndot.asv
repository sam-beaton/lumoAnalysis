...
% - Stores stim/pulse data for every channel
    ...
    if num_synchs == 0
        ...
        for k = 1:num_stim
            ...
            switch stimName
                case 'Q'
                    field_names{k} = 'Pulse_1'; 
                case 'P'
                    field_names{k} = 'Pulse_2'; 
                case 'R'
                    field_names{k} = 'Pulse_3'; 
                case 'S'
                    field_names{k} = 'Pulse_4'; 
                case 'T'
                    field_names{k} = 'Pulse_5'; 
                case 'U'
    ...
    info.pairs.NN = ones(size(nirsData.SD.MeasList(:,3))); %initialize as all 1's, we'll calculate NN below
