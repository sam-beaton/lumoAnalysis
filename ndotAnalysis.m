...
outputDir=strcat('/Users/sambe/Data/imageRecon/neurodot/workbench/'); %Output Directory for files
...
% head models
jacobianDir=strcat('/Users/sambe/Data/imageRecon/neurodot/Jacobians/');
...
keep = info.pairs.WL==2 & info.pairs.r2d < 45 & info.MEAS.GI; % measurements to include
